...
| `elixir-review-execution` | port to Rust | pending | `cerberus-core` reviewer execution and harness runtime. | Port routing, timeout, degraded-reviewer, and local-review fixtures. |
