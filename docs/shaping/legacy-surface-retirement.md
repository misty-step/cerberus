...
| `elixir-review-execution` | port to Rust | pending | `cerberus-core` reviewer execution and harness runtime. | Port routing, safe provider prompt transport, budget-approved provider-backed peer evals, and hosted/API review fixtures. |
