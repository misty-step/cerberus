...
- Consumer quick start: `README.md`
- API contract: `docs/api-contract.md`
- Migration to API mode: `docs/MIGRATION.md`
...
- Hosted API HTTP service smoke plan:
...
- Hosted API store contract plan:
  `docs/shaping/005-hosted-api-store-contract-plan.html`
- Verdict store SQLite decision plan:
  `docs/shaping/005-verdict-store-sqlite-decision-plan.html`
