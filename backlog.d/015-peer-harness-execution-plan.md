...
and receive a schema-valid `PeerHarnessExecutionPlan.v1` while the default
...
- `PeerHarnessExecutionPlan.v1` schema and validation.
...
`PeerHarnessExecutionPlan.v1` is now schema-validated and emitted by
