...
class ErrorSourceConfig:
    ...
    def from_dict(cls, raw: dict[str, Any]) -> "ErrorSourceConfig":
        ...
        poll_lines = _coerce_optional_int(raw.get("pollLines", raw.get("poll_lines")), "pollLines")
...
class ErrorTrackingConfig:
    ...
    def from_dict(cls, raw: dict[str, Any] | None = None) -> "ErrorTrackingConfig":
        ...
        return cls(
            spike_window_seconds=_coerce_optional_int(
            ...
            spike_min_count=_coerce_optional_int(
                raw.get("spikeMinCount", raw.get("spike_min_count")),
                "spikeMinCount",
                allow_none=False,
            )
            or 5,
            trend_bucket_seconds=_coerce_optional_int(
                raw.get("trendBucketSeconds", raw.get("trend_bucket_seconds")),
                "trendBucketSeconds",
                allow_none=False,
            )
            or 300,
            trend_buckets=_coerce_optional_int(
